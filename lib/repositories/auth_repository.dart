...
import 'package:cubit_authgoogle/constants/db_constant.dart';
...
class AuthRepository {
  ...
  async{
    try {
      final fbAuth.UserCredential userCredential = await firebaseAuth.createUserWithEmailAndPassword(email: email, password: password);
